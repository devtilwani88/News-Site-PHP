            ...
            <div class="col-md-8">
              ...
              <div class="post-container">
                ...
                if(isset($_GET['aid'])){
                  ...
                  $sql1 = "SELECT * FROM news JOIN users
                          ON news.author = users.Uid
                          WHERE news.author = {$auth_id}";
                  $result1 = mysqli_query($conn, $sql1) or die("Query Failed.");
                  $row1 = mysqli_fetch_assoc($result1);

                ?>
                <h2 class="page-heading">News Articles By <?php echo $row1['Fname'] . " " . $row1['Lname']; ?></h2>
                <?php
